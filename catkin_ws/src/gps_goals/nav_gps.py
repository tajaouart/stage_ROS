...
def get_origin_lat_long():
  ...
  rospy.loginfo("Getting the origin GPS location from ~/gps/fix~ Topic...")
  robot_gps = rospy.wait_for_message('/gps/fix', NavSatFix)
  origin_lat  = robot_gps.latitude
  origin_long = robot_gps.longitude
